              ...
              <div className="mb-6">
                <div className="flex gap-2 mb-4">
                  ...
                  <button
                    onClick={checkAnswer}
                    disabled={loading}
                    className="bg-fuchsia hover:bg-fuchsia-hover text-white px-4 py-2 rounded-lg flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    <IoSend size={18} />
                  </button>
                </div>
