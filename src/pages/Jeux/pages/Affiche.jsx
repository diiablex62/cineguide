  ...
  return (
    <div className="flex flex-col lg:flex-row mb-5">
      ...
      <div className="w-full lg:w-6/8 lg:flex lg:flex-col lg:justify-around lg:items-center lg:h-screen  px-3">
        ...
        <form
          className="flex flex-col items-center justify-center w-full lg:justify-start"
          action=""
        >
          ...
          <div className="flex flex-col items-center justify-center lg:w-full ">
            ...
            <input
              className="border p-1 w-[80%] lg:w-[50%] mt-3"
              id="genre"
              name="genre"
              type="text"
            />
            <p className="italic text-center">Aucun genre séléctionné</p>
