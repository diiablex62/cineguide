...
export default function CardSerie() {
  ...
  // Check if filteredSeries exists before checking length
        ...
        {filteredSeries.map((serie, index) => (
          <div
            ...
            <div className='w-[70%] flex flex-col justify-center mt-2 shadow-xl py-4 px-4'>
              ...
              <div className='flex'>
                <p className='mr-3'>
                  {serie.dateDebut ? new Date(serie.dateDebut).getFullYear() : "N/A"}
                </p>
              ...
              <div className='flex flex-col '>
                <button
                  onClick={() => toggleState && toggleState(setGoSeeStates, serie.id)}
                ...
                <div className='flex'>
                  ...
                  <button
                    onClick={() => toggleState && toggleState(setAlreadySeenStates, serie.id)}
                    className={`mt-2 cursor-pointer text-white w-[130px] h-[40px] lg:text-[15px] ${
            ...
            <SwiperSlide
              ...
              <div className='relative'>
                <NavLink
                  ...
                  className='w-[375px]'>
                  <img className='w-[375px]' src={serie.image} alt={serie.titre} />
                </NavLink>
                <button
                  onClick={() => toggleState && toggleState(setOpenInfoStates, serie.id)}
              ...
              <div
                ...
                <p className='font-bold text-2xl'>{serie.titre}</p>
                <p>{serie.dateDebut ? new Date(serie.dateDebut).getFullYear() : "N/A"}</p>
